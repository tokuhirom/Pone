...
int main(int argc, char** argv) {
    ...
    pone_assign(world, 0, "$x", pone_mortalize(world, pone_new_int(world->universe, 4963)));
...

    {
        ...
        pone_assign(world, 1, "$x", pone_mortalize(world, pone_new_int(world->universe, 5555)));
        pone_builtin_say(world, pone_get_lex(world, "$x"));
        assert(pone_int_val(pone_get_lex(world, "$x")) == 5555);
        pone_assign(world, 1, "$y", pone_mortalize(world, pone_new_int(world->universe, 1111)));
        pone_freetmps(world);
